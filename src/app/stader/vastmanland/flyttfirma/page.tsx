...
export const metadata: Metadata = {
  title: 'Flyttfirma Västmanland - Trygg flytt med RUT-avdrag | Smidig Flytt',
  description: 'Flyttfirma i Västmanland. Professionell flytthjälp med RUT-avdrag.',
  alternates: {
    canonical: 'https://smidigflytt.se/stader/vastmanland/flyttfirma',
  },
}

export default function VastmanlandFlyttfirmaPage() {
  const region = {
    name: 'Västmanland',
    cities: [
