...
export const metadata: Metadata = {
  title: 'Städfirma Örebro Län - Hemstädning med RUT-avdrag | Smidig Flytt',
  description: 'Städfirma i Örebro län. Professionell hemstädning med RUT-avdrag.',
  alternates: {
    canonical: 'https://smidigflytt.se/stader/orebro-lan/stadfirma',
  },
}

export default function OrebroLanStadfirmaPage() {
  const region = {
    name: 'Örebro län',
    cities: [
