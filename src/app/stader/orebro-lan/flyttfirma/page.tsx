...
export const metadata: Metadata = {
  title: 'Flyttfirma Örebro Län - Trygg flytt med RUT-avdrag | Smidig Flytt',
  description: 'Flyttfirma i Örebro län. Professionell flytthjälp med RUT-avdrag.',
  alternates: {
    canonical: 'https://smidigflytt.se/stader/orebro-lan/flyttfirma',
  },
}

export default function OrebroLanFlyttfirmaPage() {
  const region = {
    name: 'Örebro län',
    cities: [
