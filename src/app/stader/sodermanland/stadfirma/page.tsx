...
export const metadata: Metadata = {
  title: 'Städfirma Södermanland - Hemstädning med RUT-avdrag | Smidig Flytt',
  description: 'Städfirma i Södermanland. Professionell hemstädning med RUT-avdrag.',
  alternates: {
    canonical: 'https://smidigflytt.se/stader/sodermanland/stadfirma',
  },
}

export default function SodermanlandStadfirmaPage() {
  const region = {
    name: 'Södermanland',
    cities: [
